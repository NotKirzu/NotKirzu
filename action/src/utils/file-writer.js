...
const outputPath = './kirzu-stats-card/';
...
const generatePreviewMarkdown = function (isInGithubAction) {
    ...
    const urlPrefix = isInGithubAction
        ? `https://raw.githubusercontent.com/${GITHUB_REPOSITORY}/${GITHUB_BRANCH}/kirzu-cards-stats`
        : `.`;
...
function getThemeMarkdown(urlPrefix) {
    let result = '';
    result += `
[![](${urlPrefix}/0-profile-details.svg)](https://github.com/NotKirzu/NotKirzu)
[![](${urlPrefix}/1-repos-per-language.svg)](https://github.com/NotKirzu/NotKirzu) [![](${urlPrefix}/2-most-commit-language.svg)](https://github.com/NotKirzu/NotKirzu)
[![](${urlPrefix}/3-stats.svg)](https://github.com/NotKirzu/NotKirzu) [![](${urlPrefix}/4-productive-time.svg)](https://github.com/NotKirzu/NotKirzu)
`;
    return result;
}
